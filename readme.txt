...
Créer le controleur (content.controller.js) pour faire le lien entre le routeur et le modèle. -Le code a été emprunté au groupe de Dorian Bouchet pour nous permettre
